...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;1,400&family=Lora:ital,wght@0,400;0,500;1,400&family=JetBrains+Mono:wght@300;400&display=swap');
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div>
          <div style={{ fontSize: 11, letterSpacing: "0.25em", color: "rgba(250,247,242,0.5)", fontFamily: "'JetBrains Mono', monospace", textTransform: "uppercase", marginBottom: 16 }}>
            FamilyPause
          </div>
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 36, fontWeight: 400, color: T.bg, lineHeight: 1.2, marginBottom: 20 }}>
            The weekly reset<br />every family needs.
          </div>
...
function SignIn({ onSwitch, onSuccess }) {
  ...
  return (
    <AuthShell>
      ...
      <div className="fp-fade-5" style={{ textAlign: "center" }}>
