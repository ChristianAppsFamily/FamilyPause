...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,700;1,400;1,500&family=Lora:ital,wght@0,400;0,500;1,400&family=JetBrains+Mono:wght@300;400&display=swap');
...
function CardBack({ style = {} }) {
  return (
    <div style={{
      ...
      borderRadius: 20,
      padding: "36px 32px",
      boxShadow: "0 20px 60px rgba(184,92,56,0.2)",
      display: "flex",
          ...
          return (
            <div key={year} style={{ marginTop: 24 }}>
              ...
              <div style={{
                ...
                {/* Decorative */}
                <div style={{ position: "absolute", top: -20, right: -20, width: 120, height: 120, borderRadius: "50%", background: "rgba(184,92,56,0.08)", pointerEvents: "none" }} />
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <button onClick={onUnlock} style={{
                    ...
                    transition: "all 0.15s",
                    boxShadow: `0 4px 12px rgba(184,92,56,0.25)`,
                  }}>
                    Get the {year} Deck →
                  </button>
                  <a href="https://familypause.com/cards" target="_blank" rel="noreferrer" style={{
